...
source = root / 'docs' / 'Backend-From-Zero-Guide.md'
...
message['To'] = 'ns04001@gmail.com'
message['Subject'] = 'Equipment Management Backend — Beginner Development Guide'
message['X-Unsent'] = '1'
message.set_content('Attached is the offline beginner guide covering C#, .NET 8, PostgreSQL setup, entities, relationships, DbContext, migrations, services, APIs, reservations, data population, testing, and moving the project to another IDE/computer.\n\nThis is a prepared draft and has not been sent.')
message.add_attachment(docx_path.read_bytes(), maintype='application', subtype='vnd.openxmlformats-officedocument.wordprocessingml.document', filename=docx_path.name)
(source.parent / 'Backend-Guide-Email-Draft.eml').write_bytes(message.as_bytes())
print('Created and structurally validated DOCX; created offline HTML and unsent email draft.')
for path in [source, docx_path, html_path, source.parent / 'Backend-Guide-Email-Draft.eml']:
